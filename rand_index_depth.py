...
classification_vec1 = ['physics'] #,'biogeo','biogeo']
depth_vec1 = ['DA'] #'bottom','bottom','DA']

#classification_vec2 = ['biogeo','biogeo','biogeo']
depth_vec2 = ['bottom'] #,'20','30','40','50','60','70','80','90','100'] #'bottom','DA','DI','DA','DI','DI']

for i in range(len(depth_vec2)):
    #print(classification_vec1[i])
    print(depth_vec1[0])
    ...
    for rep in range(total_reps):
        ...
        train1.predict()
        train2 = run_initial_model(classification_vec1[0],depth_vec2[i],rep)
        train2.predict()
